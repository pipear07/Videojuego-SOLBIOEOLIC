...
public class Yogan_m : MonoBehaviour
{
    ...
    void checkConditions()
    {
        ...
        {
            if (distancia_actual_1 + 20 <= distancia_para_seguirlo_1) //necesito sumarle 20 posiciones a la posicion actual del enemigo
            {//esto es fundamental para que cuando el stop de la maya pare, este pare al mismo tiempo
        ...
        {
            if (distancia_actual_2 + 20 <= distancia_para_seguirlo_2)
            {
