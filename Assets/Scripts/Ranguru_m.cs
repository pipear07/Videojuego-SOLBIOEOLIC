...
public class Ranguru_m : MonoBehaviour
{
    ...
    void checkConditions()
    {
        ...
        if (activar_dragon == true)
        {
            ...
            {//HIKARI
                ...
                if (distancia_actual_1 + 15 <= distancia_para_seguirlo_1) //entre mas positivo mas cerca, entre mas negativo mas lejos
                {
            ...
            {//YAMI
                if (distancia_actual_2 + 15 <= distancia_para_seguirlo_2)
                {
